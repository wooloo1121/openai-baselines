...
def train(args, extra_args):
    ...
    for i in range(num_agents):
        q_exp.append(manager.Queue())
        q_model.append(manager.Queue())
    ...
    for alg in algs:
        ...
        p.append(mp.Process(target=learn, kwargs={'args': args, 'extra_args': extra_args, 'q_exp': q_exp, 'q_model': q_model, 'network': alg_kwargs['network']}))
